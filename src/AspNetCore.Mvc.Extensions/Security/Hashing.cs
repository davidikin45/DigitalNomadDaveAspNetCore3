...
namespace AspNetCore.Mvc.Extensions.Security
{
    public class HashData
	{
        ...
        //Password Based Key Derivation. Salt reduces rainbow table attacks. Iterations doubled every 2 years.
        public static byte[] HashPasswordWithSaltRfc2898(byte[] toBeHashed, byte[] salt, int numberOfRounds = 100000)
        {
