...
namespace AspNetCore.Mvc.Extensions.Controllers.ApiClient
{
       ...
       where TReadDto : class
    {
        ...
        protected readonly JsonSerializerOptions settings;

        public GenericReadOnlyApiClient(HttpClient client, JsonSerializerOptions settings, string resourceCollection)
        {
            this.client = client;
