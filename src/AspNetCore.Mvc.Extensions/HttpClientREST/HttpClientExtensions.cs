...
namespace GrabMobile.ApiClient.HttpClientREST
{
    public static class HttpClientExtensions
    {
        ...
        public static async Task<HttpResponseMessage> Post(this HttpClient client, string requestUri, object value, JsonSerializerOptions serializerOptions, CancellationToken cancellationToken = default(CancellationToken))
            => await Post(client, requestUri, value, serializerOptions, "", cancellationToken);

        public static async Task<HttpResponseMessage> Post(this HttpClient client,
            string requestUri, object value, JsonSerializerOptions serializerOptions, string bearerToken, CancellationToken cancellationToken = default(CancellationToken))
        {
            var builder = new HttpRequestBuilder()
        ...
        public static async Task<HttpResponseMessage> PostAsStream(this HttpClient client, string requestUri, object value, JsonSerializerOptions serializerSettings, CancellationToken cancellationToken = default(CancellationToken))
        ...
        public static async Task<HttpResponseMessage> Put(this HttpClient client, string requestUri, object value, JsonSerializerOptions serializerOptions, CancellationToken cancellationToken = default(CancellationToken))
            => await Put(client, requestUri, value, serializerOptions, "", cancellationToken);
        ...
        public static async Task<HttpResponseMessage> Patch(this HttpClient client, string requestUri, object value, JsonSerializerOptions serializerOptions, CancellationToken cancellationToken = default(CancellationToken))
            => await Patch(client, requestUri, value, serializerOptions, "", cancellationToken);

        public static async Task<HttpResponseMessage> Patch(this HttpClient client, string requestUri, object value, JsonSerializerOptions serializerOptions, string bearerToken, CancellationToken cancellationToken = default(CancellationToken))
        {
            var builder = new HttpRequestBuilder()
                                .AddMethod(new HttpMethod("PATCH"))
                                .AddRequestUri(requestUri)
                                .AddContent(new PatchContent(value, serializerOptions))
                                .AddBearerToken(bearerToken);
        ...
        public static async Task<HttpResponseMessage> Delete(this HttpClient client, string requestUri, object value, JsonSerializerOptions serializerOptions, CancellationToken cancellationToken = default(CancellationToken))
        {
            var builder = new HttpRequestBuilder()
