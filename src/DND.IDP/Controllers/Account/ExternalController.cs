using DND.IDP.Controllers.UserRegistration;
    ...
    public class ExternalController : Controller
    {
        ...
        public async Task<IActionResult> Callback()
        {
            ...
            if (user == null)
            {
                ...
                //user = AutoProvisionTestUser(provider, providerUserId, claims);
                ...
                if (provider == "Facebook")
                {
                    ...
                    if (email != null)
                    {
                        ...
                        if (userByEmail != null)
                        {
                            ...
                            _userRepository.AddUserLogin(userByEmail.SubjectId, provider, providerUserId);
                ...
                var continueWithUrl = Url.Action(nameof(UserRegistrationController.RegisterUser), "UserRegistration"
        ...
        private (TestUser user, string provider, string providerUserId, IEnumerable<Claim> claims) FindTestUserFromExternalProvider(AuthenticateResult result)
        {
            var externalUser = result.Principal;
        ...
        private TestUser AutoProvisionTestUser(string provider, string providerUserId, IEnumerable<Claim> claims)
        {
