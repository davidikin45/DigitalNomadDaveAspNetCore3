## Pluralsight Courses for ASP.NET Core 3
* [Understanding ASP.NET Core 3.x](https://app.pluralsight.com/library/courses/understanding-aspdotnet-core-3x/table-of-contents)
...
## Pluralsight Courses for Configuration and Options
* [Using Configuration and Options in .NET Core and ASP.NET Core Apps](https://app.pluralsight.com/library/courses/dotnet-core-aspnet-core-configuration-options/table-of-contents)
...
* [Implementing Advanced RESTful Concerns with ASP.NET Core 3](https://app.pluralsight.com/library/courses/asp-dot-net-core-3-advanced-restful-concerns/table-of-contents)
...
## Pluralsight Courses for Logging
* [Effective Logging in ASP.NET Core](https://app.pluralsight.com/library/courses/asp-dotnet-core-effective-logging/table-of-contents)
* [Serilog Enrichers: Getting Common Information into Log Entries](https://app.pluralsight.com/library/courses/serilog-enrichers-getting-info-into-log-entries/table-of-contents)
...
## Pluralsight Courses for Nulls
* [Working with Nulls in C#](https://app.pluralsight.com/library/courses/working-with-nulls-csharp/table-of-contents)

## Pluralsight Courses for Security
* [Configuring Security Headers in ASP.NET and ASP.NET Core Applications](https://app.pluralsight.com/library/courses/asp-dot-net-and-core-configuring-security-headers/exercise-files)